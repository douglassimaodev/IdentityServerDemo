        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                new Client
                {
                    ...
                    //Wont ask for user to confirm anything during login
                    //Nao vai peder para o usuario confirmar nada durante o login
                    RequireConsent = false,                   

                    //Here is the Url from your blazor project
                    RedirectUris = { "https://localhost:44331/authentication/login-callback" },
                    FrontChannelLogoutUri = "https://localhost:44331/authentication/signout-oidc",
